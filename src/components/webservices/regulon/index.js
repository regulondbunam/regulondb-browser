...
import {query_GET_REGULON_BY, query_GET_ALL_REGULON, query_GET_REGULON_BYV2, query_GET_REGULON_BYSearch} from "./query"
...
export function useGetRegulonData(id) {
    ...
    const [getData, {data: data2, error: error2, loading: loading2}] = useLazyQuery(query_GET_REGULON_BY, options )
