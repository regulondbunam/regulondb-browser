...
import {Modal as ModalComponent} from '../ui-components/ui_components'
...
export const Modal = ({
   ...
   // let evidence = ""
    ...
    return ( 
        <ModalComponent className={`aBase ${classNameModal}`} style={styleStrong} title={title} info={eviref} />
     );
    } catch (error) {
