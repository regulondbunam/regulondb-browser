                                        ...
                                        return (
                                            <tr key={`${key}-geneInfo-${key}`}>
                                                ...
                                                <td>
                                                    ...
                                                    <ReactTooltip type="light" border={true} place="bottom" />
                                                </td>
                                            </tr>
                                        )
                                    case 'citations':
            ...
            <td>
                {
                    products.map((product) => {
                        return (
                            <a href={`/gene/${idGene}/products#${product.id}`} key={`${product.name}-infoTable`} >{product.name}</a>
                        )
                    })
                }
            </td>
    ...
    return (
        <tr key={key}>
            ...
            <td className="sequence" >
                <Modal className="aBase" title={"Fasta Format"} info={Sequence('gene', sequence, "fasta", `${gene} gene sequence`, true)}></Modal>
                <Modal className="aBase" title={"genbank Format"} info={Sequence('gene', sequence, "genbank", `${gene} gene sequence`, true)}></Modal>
            </td>
        </tr>
    )
}
