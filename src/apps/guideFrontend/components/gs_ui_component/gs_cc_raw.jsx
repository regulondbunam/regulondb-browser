...
const GSCcRaw = ({setState}) => {
  ...
  const [ _url, set_url ] = useState("https://raw.githubusercontent.com/regulondbunam/component-repository/master/ui-components/README.md?token=GHSAT0AAAAAAB5IDW4MVOQGNIWV555Y5VJOZAY2DZA");
